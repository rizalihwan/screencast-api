                ...
                <form method="POST" action="{{ route('screencast.playlists.update', $playlist->id) }}"
                    ...
                    <div class="mb-4">
                        ...
                        @if ($playlist->thumbnail)
                            <img src="{{ $playlist->ShowThumbnail() }}" style="width: 100px; height: 100px; object-fit: cover; object-position: center;" alt="PlaylistThumbnail" class="my-3">
                        @endif
                        <input
                    ...
                    <div class="mb-4">
                        ...
                        @if ($errors->playlist_update->has('description'))
                            <p class="text-red-500 text-xs italic">{{ $errors->playlist_update->first('description') }}
                            </p>
                        @endif
                    </div>
                    <div class="mb-6">
