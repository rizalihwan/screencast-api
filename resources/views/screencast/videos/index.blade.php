                                    ...
                                    <tr class="text-gray-700">
                                        ...
                                        <td class="px-4 py-5 text-ms font-semibold border">
                                            ...
                                            <button type="submit" onclick="deleteItem('{{ $key->slug }}')"
                                                class="mt-5 p-3 bg-transparent border-2 border-red-500 text-red-500 text-lg rounded-lg hover:bg-red-500 hover:text-gray-100 focus:border-4 focus:border-red-300"><i
        ...
        <script>
            ...
            function deleteItem(id) {
                Swal.fire({
                    ...
                    confirmButtonText: 'Yakin, hapus Video',
                    cancelButtonText: 'Batalkan',
                    allowOutsideClick: false
                }).then((result) => {
                    if (result.isConfirmed) {
                        Swal.fire({
                            title: "Sedang menghapus Video",
